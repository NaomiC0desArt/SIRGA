        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MustCompleteProfile = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profesores_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CursosAcademicos_Grados_IdGrado",
                        column: x => x.IdGrado,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClasesProgramadas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClasesProgramadas_Asignaturas_IdAsignatura",
                        column: x => x.IdAsignatura,
                        principalTable: "Asignaturas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClasesProgramadas_CursosAcademicos_IdCursoAcademico",
                        column: x => x.IdCursoAcademico,
                        principalTable: "CursosAcademicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClasesProgramadas_Profesores_IdProfesor",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inscripciones_CursosAcademicos_IdCursoAcademico",
                        column: x => x.IdCursoAcademico,
                        principalTable: "CursosAcademicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClasesProgramadas_IdAsignatura",
                table: "ClasesProgramadas",
                column: "IdAsignatura");

            migrationBuilder.CreateIndex(
                name: "IX_ClasesProgramadas_IdCursoAcademico",
                table: "ClasesProgramadas",
                column: "IdCursoAcademico");

            migrationBuilder.CreateIndex(
                name: "IX_ClasesProgramadas_IdProfesor",
                table: "ClasesProgramadas",
                column: "IdProfesor");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inscripciones_IdCursoAcademico",
                table: "Inscripciones",
                column: "IdCursoAcademico");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Profesores_ApplicationUserId",
                table: "Profesores",
                column: "ApplicationUserId",
                unique: true);
        }
