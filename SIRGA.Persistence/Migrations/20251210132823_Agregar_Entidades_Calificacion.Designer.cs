...
namespace SIRGA.Persistence.Migrations
{
    ...
    [Migration("20251210132823_Agregar_Entidades_Calificacion")]
    partial class Agregar_Entidades_Calificacion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.Aula", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.Calificacion", b =>
                {
                    ...
                    b.HasIndex("IdCursoAcademico", "IdAsignatura", "IdPeriodo")
                        .HasDatabaseName("IX_Calificacion_Curso_Asignatura_Periodo");

                    b.HasIndex("IdEstudiante", "IdAsignatura", "IdPeriodo")
                        .IsUnique()
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.CalificacionDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("IdComponenteCalificacion")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdComponenteCalificacion");

                    b.HasIndex("IdCalificacion", "IdComponenteCalificacion")
                        .IsUnique()
                        .HasDatabaseName("IX_CalificacionDetalle_Unique");

                    b.ToTable("CalificacionDetalles");
                });
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.ComponenteCalificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.CursoAcademico", b =>
                {
                    ...
                    b.HasIndex("IdAulaBase");

                    b.HasIndex("IdSeccion");

                    b.HasIndex("IdGrado", "IdSeccion", "IdAnioEscolar")
                        .IsUnique()
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.HistorialCalificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NombreUsuarioModificador")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("RolUsuarioModificador")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("HistorialCalificaciones");
                });
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.Inscripcion", b =>
                {
                    ...
                    b.HasIndex("IdEstudiante", "IdCursoAcademico")
                        .IsUnique()
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.Seccion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.CalificacionDetalle", b =>
                {
                    b.HasOne("SIRGA.Domain.Entities.Calificacion", "Calificacion")
                        .WithMany("Detalles")
                        .HasForeignKey("IdCalificacion")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SIRGA.Domain.Entities.ComponenteCalificacion", "Componente")
                        .WithMany()
                        .HasForeignKey("IdComponenteCalificacion")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SIRGA.Domain.Entities.CursoAcademico", b =>
                {
                    ...
                    b.HasOne("SIRGA.Domain.Entities.Aula", "AulaBase")
                        .WithMany()
                        .HasForeignKey("IdAulaBase")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("SIRGA.Domain.Entities.Seccion", "Seccion")
                        .WithMany()
